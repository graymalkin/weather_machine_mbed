...
OBJECTS = ./main.o \
		  ...
		  ./NeoPixel/neo.o ./NeoPixel/delay.o \
		  ./wsDrive/wsDrive.o \
		  ./weather/weather.o \
...
CC_FLAGS = $(CPU) -c -O0 -g -fno-common -fmessage-length=0 -Wall -Wextra -fno-exceptions -ffunction-sections -fdata-sections -fomit-frame-pointer -MMD -MP
